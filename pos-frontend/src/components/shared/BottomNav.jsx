    ...
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <div className="relative flex items-center justify-center">
        <button 
          ...
          className={`flex items-center justify-center font-bold ${
            isMoreMenuOpen ? "text-[#f5f5f5] bg-[#343434]" : "text-[#ababab]"
          } w-[300px] rounded-[20px]`}
        >
        ...
        {isMoreMenuOpen && (
          <div className="absolute bottom-16 left-0 bg-[#262626] rounded-lg shadow-lg border border-[#343434] z-50 w-48">
            <button
              onClick={() => {
                navigate("/menu");
                setIsMoreMenuOpen(false);
              }}
              className="flex items-center gap-3 w-full px-4 py-3 text-[#f5f5f5] hover:bg-[#343434] rounded-lg transition"
            >
